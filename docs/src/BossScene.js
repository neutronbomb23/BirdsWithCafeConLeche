...
export class BossScene extends Phaser.Scene{
    ...
    preload(){ // precarga los assets
        ...
        this.load.spritesheet('RickIddle', 'assets/pigeon_pecking/palomoRick.png', {frameWidth:31,  frameHeight: 32});// idle de Rick
    ...
    create(){
        ...
        this.physics.add.collider(this.rick, this.floor);
